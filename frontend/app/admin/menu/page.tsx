...
export default function MenuPage() {
  ...
  // Input style matching file 1's dark gold aesthetic
  const inputCls =
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full bg-black pt-20">
        ...
        {/* ── HERO ── */}
        <motion.div
          className="px-6 sm:px-10 pt-10 pb-12 sm:pb-16 max-w-3xl"
          initial="hidden"
          animate="show"
        ...
        {/* ── MENU SECTIONS ── */}
        <div className="px-6 sm:px-10 py-12 sm:py-16 max-w-5xl mx-auto flex flex-col gap-14 sm:gap-20">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            <div>
              <label className="text-[#d4a762]/50 text-xs uppercase tracking-widest block mb-1.5">Image URL</label>
              <input className={inputCls} placeholder="https://..."
                value={addForm.imageUrl} onChange={(e) => setAddForm((f) => ({ ...f, imageUrl: e.target.value }))} />
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUp} className="flex items-center gap-3 mb-6">
            <button
              ...
              className={`w-10 h-5 rounded-full transition-colors duration-200 relative ${addForm.isAvailable ? "bg-[#c49a45]" : "bg-[#1e1508]"}`}
            >
              <span className={`absolute top-0.5 w-4 h-4 bg-white rounded-full transition-transform duration-200 ${addForm.isAvailable ? "translate-x-5" : "translate-x-0.5"}`} />
            </button>
            ...
            >
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                  ...
                  <div>
                    <label className="text-[#d4a762]/50 text-xs uppercase tracking-widest block mb-1.5">Image URL</label>
                    <input className={inputCls} value={editForm.imageUrl}
                ...
                <div className="flex items-center gap-3 mb-6">
                  <button
                    ...
                    className={`w-10 h-5 rounded-full transition-colors duration-200 relative ${editForm.isAvailable ? "bg-[#c49a45]" : "bg-[#1e1508]"}`}
                  >
                    <span className={`absolute top-0.5 w-4 h-4 bg-white rounded-full transition-transform duration-200 ${editForm.isAvailable ? "translate-x-5" : "translate-x-0.5"}`} />
                  </button>
                  <span className="text-gray-500 text-sm">Available</span>
                </div>
